...
export const FlagGB = ({ className = "w-5 h-3.5 rounded-xs object-cover inline-block shrink-0 shadow-xs" }) => (
  <svg className={className} viewBox="0 0 60 30" xmlns="http://www.w3.org/2000/svg">
    <clipPath id="s_gb_a"><path d="M0,0 v30 h60 v-30 z"/></clipPath>
    <clipPath id="t_gb_a"><path d="M30,15 m-30,0 l30,-15 l30,15 l-30,15 z h-30 v-30 h60 v30 z"/></clipPath>
    <g clipPath="url(#s_gb_a)">
      <path d="M0,0 v30 h60 v-30 z" fill="#012169"/>
      <path d="M0,0 l60,30 M60,0 l-60,30" stroke="#fff" strokeWidth="6"/>
      <path d="M0,0 l60,30 M60,0 l-60,30" stroke="#C8102E" strokeWidth="4" clipPath="url(#t_gb_a)"/>
...
export const FlagDE = ({ className = "w-5 h-3.5 rounded-xs object-cover inline-block shrink-0 shadow-xs" }) => (
